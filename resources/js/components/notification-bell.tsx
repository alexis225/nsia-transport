...
export default function NotificationBell() {
    ...
    const fetchNotifications = async (force = false) => {
        if (!force && Date.now() - lastActionAt.current < GRACE_MS) {
            return;
        }
        ...
        try {
            ...
            // Erreur réseau ponctuelle : on réessaiera au prochain polling.
        }
    };
    ...
    const markRead = async (id: string) => {
        // eslint-disable-next-line react-hooks/purity -- gestionnaire d'evenement, pas execute pendant le rendu
        ...
        try {
            ...
            // Erreur réseau ponctuelle : l'update optimiste reste affiché.
        }
    };
