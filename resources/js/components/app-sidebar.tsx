...
export function AppSidebar() {
    ...
    const partnerNavItems = [
        ...
        },
        {
            ...
            children: [
                ...
                { title: t('items.accountSecurity'), href: route('user-password.edit') },
    ...
    const mainNavItems = isPartner() ? partnerNavItems : [
        ...
        ...(can('users.view') ? [{
            ...
            icon:  Users,
            children: [
                { title: t('items.list'), href: route('admin.users.index') },
                ...(can('users.block')  ? [{ title: t('items.blockedUsers'), href: route('admin.users.index') + '?status=blocked' }] : []),
                ...(can('users.create') ? [{ title: t('items.newUser'), href: route('admin.users.create') }] : []),
                ...(isSA() ? [
                    { title: t('items.roles'), href: route('admin.roles.index') },
                    { title: t('items.newRole'), href: route('admin.roles.index') + '?action=create' },
                    { title: t('items.tenants'), href: route('admin.tenants.index') },
                    { title: t('items.newTenant'), href: route('admin.tenants.create') },
                ] : []),
            ],
        }] : []),
        ...
        ...(can('brokers.view') && moduleEnabled('brokers') ? [{
            ...
            icon:  Briefcase,
            children: [
                { title: t('items.list'), href: route('admin.brokers.index') },
                ...(can('brokers.create') ? [{ title: t('items.newBroker'), href: route('admin.brokers.create') }] : []),
            ],
        }] : []),
        ...
        ...(can('coinsurers.view') && moduleEnabled('coinsurers') ? [{
            ...
            icon:  Users2,
            children: [
                { title: t('items.list'), href: route('admin.coinsurers.index') },
                ...(can('coinsurers.create') ? [{ title: t('items.new'), href: route('admin.coinsurers.create') }] : []),
            ],
        }] : []),
        ...
        ...(can('experts.view') && moduleEnabled('experts') ? [{
            ...
            icon:  UserCheck,
            children: [
                { title: t('items.list'), href: route('admin.experts.index') },
                ...(can('experts.create') ? [{ title: t('items.new'), href: route('admin.experts.create') }] : []),
            ],
        }] : []),
        ...
        ...(isSA() ? [{
            ...
            icon:  Database,
            children: [
                { title: t('items.countries'), href: '/admin/reference?tab=countries' },
                { title: t('items.currencies'), href: '/admin/reference?tab=currencies' },
                { title: t('items.incoterms'), href: '/admin/reference?tab=incoterms' },
                { title: t('items.transportModes'), href: '/admin/reference?tab=transport_modes' },
                { title: t('items.merchandiseCategories'), href: '/admin/reference?tab=merchandise_categories' },
            ],
        }] : []),
        ...
        ...(isSA() && moduleEnabled('certificate_templates') ? [{
            ...
            icon:  FileBadge,
            children: [
                { title: t('items.list'), href: route('admin.certificate-templates.index') },
                { title: t('items.new'), href: route('admin.certificate-templates.create') },
                { title: t('items.fieldPositions'), href: route('admin.certificate-print-templates.index') },
                { title: t('items.visualCalibrator'), href: '/tools/calibreur_nsia_togo.html', external: true },
            ],
        }] : []),
        ...
        ...(can('contracts.view') && moduleEnabled('contracts') ? [{
            ...
            icon:  FileText,
            children: [
                { title: t('items.list'), href: route('admin.contracts.index') },
                { title: t('items.limits'), href: route('admin.contracts.limits') },
                ...(can('contracts.create') ? [{ title: t('items.new'), href: route('admin.contracts.create') }] : []),
            ],
        }] : []),
        ...
        ...(can('certificates.view') && moduleEnabled('certificates') ? [{
            ...
            icon:  Award,
            children: [
                { title: t('items.list'), href: route('admin.certificates.index') },
                { title: t('items.advancedSearch'), href: route('admin.certificates.search'), icon: Search },
                { title: t('items.printModels'), href: route('admin.certificates.print-models') },
                ...(can('certificates.create')   ? [{ title: t('items.new'), href: route('admin.certificates.create') }] : []),
                ...(can('certificates.validate') ? [{ title: t('items.pending'), href: route('admin.dashboard.pending') }]   : []),
                ...(moduleEnabled('guce_certificates') ? [
                    { title: t('items.guceCertificates'), href: route('admin.guce-certificates.index') },
                    { title: t('items.guceImport'), href: route('admin.guce-certificates.create') },
                ] : []),
            ],
        }] : []),
        ...
        ...(moduleEnabled('commissions') ? [{
            ...
            icon: Percent,
            children: [
                { title: t('items.commissionRules'), href: route('admin.commissions.rules') },
                { title: t('items.commissionBordereau'), href: route('admin.commissions.bordereau') },
            ],
        }] : []),
        ...
        ...((can('certificates.view') || can('contracts.view') || can('brokers.view')) && moduleEnabled('reports') ? [{
            ...
            icon:  BarChart2,
            children: [
                ...(can('certificates.view') ? [{ title: t('items.reportCertificates'), href: route('admin.reports.certificates') }]    : []),
                ...(can('contracts.view')    ? [{ title: t('items.reportContracts'), href: route('admin.reports.contracts') }]       : []),
                ...(can('brokers.view')      ? [{ title: t('items.reportIntermediaries'), href: route('admin.reports.intermediaries') }]  : []),
            ],
        }] : []),
        ...
        ...(isSA() ? [{
            ...
            icon:  Shield,
            children: [
                { title: t('items.ipBlacklist'), href: route('admin.security.ip-blacklist.index') },
            ],
        }] : []),
        ...
        // ── Paramètres ─────────────────────────────────────────
        {
            ...
            children: [
                ...
                { title: t('items.accountSecurity'), href: route('user-password.edit') },
                { title: t('items.mfa'), href: route('user.mfa-setup') },
                { title: t('items.appearance'), href: route('appearance.edit') },
                ...((isSA() || isAdminFiliale()) && moduleEnabled('approvals') ? [{ title: t('items.escalations'), href: route('admin.approvals.index'), icon: TrendingUp }] : []),
                ...((isSA() || isAdminFiliale()) && moduleEnabled('approvals') ? [{ title: t('items.thresholds'), href: route('admin.approvals.configs'), icon: ShieldAlert }] : []),
                ...((isSA() || isAdminFiliale()) && moduleEnabled('delegations') ? [{ title: t('items.delegations'), href: route('admin.delegations.index'), icon: UserCheck }] : []),
                ...(can('audit_logs.view') && moduleEnabled('audit_logs') ? [{ title: t('items.auditLogs'), href: route('admin.audit-logs.index'), icon: ClipboardList }] : []),
                ...(moduleEnabled('notifications') ? [{ title: t('items.notifications'), href: route('admin.notifications.index'), icon: Bell }] : []),
                ...(can('certificates.view') && moduleEnabled('exports') ? [{ title: t('items.exports'), href: route('admin.exports.index'), icon: Download }] : []),
            ],
        },
    ];
