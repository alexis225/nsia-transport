            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="dash">
                            ...
                            return (
                                <div key={i} className="kpi-card">
                                    <div className="kpi-top">
                                        ...
                                        <div
                                            className={`kpi-badge ${eq ? 'kpi-zero' : up ? 'kpi-up' : 'kpi-down'}`}
                                        >
                                            {!eq &&
                                                (up ? (
                                                    <TrendingUp size={10} />
                                    ...
                                    {monthlyData.map((m, i) => (
                                        <div key={i} className="bar-col">
                                            <div
                                                className="bar"
                                                style={{
                                                    height: `${Math.max(3, (m.amount / maxAmt) * 82)}px`,
                                                }}
                                                title={t('monthly.tooltip', {
                                                    month: m.month,
                                                    issued: m.issued,
                                                })}
                                            />
                            ...
                            <div className="chart-stats">
                                <div>
                                    <div className="stat-val">
                                        {totalIssued.toLocaleString('fr-FR')}
                                    </div>
                                    <div className="stat-lbl">
                                        {t('monthly.totalIssued')}
                                    </div>
                                </div>
                                <div>
                                    <div className="stat-val">
                                                ...
                                                >
                                                    <div className="b-bar-bg">
                                                        <div
                                                            className="b-bar"
                                                            style={{
                                                                width: `${(b.count / (topBrokers[0]?.count || 1)) * 100}%`,
                                                            }}
                                                        />
                                                    </div>
                    ...
                    <div
                        className="row3"
                        style={{
                            gridTemplateColumns: isSA ? '1fr 1fr' : '1fr',
                        }}
                    >
                        <div className="chart-card">
                            <div className="chart-hdr">
                                                ...
                                                >
                                                    <div className="b-bar-bg">
                                                        <div
                                                            className="b-bar"
                                                            style={{
                                                                width: `${(t.count / (topInsured[0]?.count || 1)) * 100}%`,
                                                            }}
                                                        />
                                                    </div>
                                                    <span className="b-count">
                                                    ...
                                                    >
                                                        <div className="b-bar-bg">
                                                            <div
                                                                className="b-bar"
                                                                style={{
                                                                    width: `${(t.count / (topFiliales[0]?.count || 1)) * 100}%`,
                                                                }}
                                                            />
                                                        </div>
                                                        <span className="b-count">
                            ...
                            <table>
                                ...
                                <tbody>
                                    {recentCerts.map((cert) => {
                                        const s =
                                            STATUS[cert.status] ?? STATUS.DRAFT;
                        ...
                        <div className="ops-stats">
                            <div className="mini-card">
                                <div
                                    ...
                                    style={{ background: '#eff6ff' }}
                                >
                                    <Inbox size={17} color="#3b82f6" />
                                </div>
                                <div>
                                    <div className="mini-val">
                                        {operationalStats.received}
                                    </div>
                                    <div className="mini-lbl">
                            ...
                            <div className="mini-card">
                                ...
                                <div>
                                    <div className="mini-val">
                                        {operationalStats.processed}
                                    </div>
                                    <div className="mini-lbl">
                                        {t('operational.processed')}
                                    </div>
                                </div>
                            </div>
                        </div>
