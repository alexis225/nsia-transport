...
export default function ContractEdit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        coinsurers: (contract.coinsurers ?? []).map((c) => ({
            coinsurer_id: c.id,
            share_rate: c.pivot.share_rate,
        })),
        ...
        transport_mode_id: contract.transport_mode_id
        ...
        certificates_limit: contract.certificates_limit
            ? String(contract.certificates_limit)
            : '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={t('edit.title', { number: contract.contract_number })}
            />
            <ContractForm
                data={data}
                setData={setData}
