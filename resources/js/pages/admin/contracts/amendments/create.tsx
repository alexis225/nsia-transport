...
export default function AmendmentCreate({ contract }: Props) {
    ...
    const FIELD_LABELS: Record<string, string> = {
        ...
        accessories_amount: t(
            'amendmentEditableFieldLabels.accessories_amount',
        ),
        ...
        notice_period_days: t(
            'amendmentEditableFieldLabels.notice_period_days',
        ),
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: route('admin.contracts.amendments.index', {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(
            route('admin.contracts.amendments.store', {
                contract: contract.id,
            }),
        );
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={t('amendments.create.title', {
            ...
            <div className="flex h-full flex-1 flex-col overflow-x-auto p-4">
                <div className="am-wrap">
                    <div className="am-hero">
                        <div className="am-hero-ico">
                            <FileText size={22} color="rgba(255,255,255,0.8)" />
                        </div>
                        <div>
                            <div className="am-hero-title">
                                {t('amendments.create.heroTitle', {
                                    number: contract.contract_number,
                                })}
                            </div>
                            <div className="am-hero-sub">
                    ...
                    >
                        ...
                        <div className="am-card">
                            <div className="am-card-hdr">
                                <div className="am-card-ttl">
                                    {t('amendments.create.reasonSection.title')}
                                </div>
                            </div>
                            <div className="am-card-body">
                                <div className="grid gap-2">
                                    <Label className="am-label">
                                        {t(
                                            'amendments.create.reasonSection.reason',
                                        )}
                                    </Label>
                                    <Input
                                        className="h-11"
                                        ...
                                        placeholder={t(
                                            'amendments.create.reasonSection.reasonPlaceholder',
                                        )}
                                    />
                                ...
                                <div className="grid gap-2">
                                    <Label className="am-label">
                                        {t(
                                            'amendments.create.reasonSection.description',
                                        )}
                                    </Label>
                                    <textarea
                                        ...
                                        placeholder={t(
                                            'amendments.create.reasonSection.descriptionPlaceholder',
                                        )}
                                    />
                                </div>
                            </div>
                        ...
                        <div className="am-card">
                            <div className="am-card-hdr">
                                <div className="am-card-ttl">
                                    {t('amendments.create.fieldsSection.title')}
                                </div>
                                <div className="am-card-sub">
                                    {t(
                                        'amendments.create.fieldsSection.subtitle',
                                    )}
                                </div>
                            </div>
                            <div className="am-card-body">
                        ...
                        {selectedFields.some((f) => rateFields.includes(f)) && (
                            <div className="am-card">
                                <div className="am-card-hdr">
                                    <div className="am-card-ttl">
                                        {t(
                                            'amendments.create.ratesSection.title',
                                        )}
                                    </div>
                                </div>
                                <div className="am-card-body">
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="current-val">
                                                            {t(
                                                                'amendments.create.ratesSection.current',
                                                                {
                                                                    value:
                                                                        (
                                                                            contract as any
                        ...
                        {selectedFields.some((f) =>
                            [...dateFields, 'notice_period_days'].includes(f),
                        ) && (
                            <div className="am-card">
                                <div className="am-card-hdr">
                                    <div className="am-card-ttl">
                                        {t(
                                            'amendments.create.periodSection.title',
                                        )}
                                    </div>
                                </div>
                                <div className="am-card-body">
                                    <div className="form-grid">
                                        {selectedFields.includes(
                                            ...
                                            <div className="grid gap-2">
                                                <Label className="am-label">
                                                    {t(
                                                        'amendments.create.periodSection.effectiveDate',
                                                    )}
                                                </Label>
                                                <Input
                                                    className="h-11"
                                                ...
                                                <div className="current-val">
                                                    {t(
                                                        'amendments.create.periodSection.currentDate',
                                                        {
                                        ...
                                        {selectedFields.includes(
                                            ...
                                            <div className="grid gap-2">
                                                <Label className="am-label">
                                                    {t(
                                                        'amendments.create.periodSection.expiryDate',
                                                    )}
                                                </Label>
                                                <Input
                                                    className="h-11"
                                        ...
                                        {selectedFields.includes(
                                            ...
                                            <div className="grid gap-2">
                                                <Label className="am-label">
                                                    {t(
                                                        'amendments.create.periodSection.noticePeriod',
                                                    )}
                                                </Label>
                                                <Input
                                                    className="h-11"
                                                ...
                                                <div className="current-val">
                                                    {t(
                                                        'amendments.create.periodSection.currentDays',
                                                        {
                        ...
                        {/* Couverture & Incoterm */}
                        {selectedFields.some((f) =>
                            ['incoterm_code', 'coverage_type'].includes(f),
                        ) && (
                            <div className="am-card">
                                <div className="am-card-hdr">
                                    <div className="am-card-ttl">
                                        {t(
                                            'amendments.create.coverageSection.title',
                                        )}
                                    </div>
                                </div>
                                <div className="am-card-body">
                                    <div className="form-grid">
                                        {selectedFields.includes(
                                            ...
                                            <div className="grid gap-2">
                                                <Label className="am-label">
                                                    {t(
                                                        'amendments.create.coverageSection.coverageType',
                                                    )}
                                                </Label>
                                                <select
                                                    className="am-select"
                                                ...
                                                >
                                                    ...
                                                    <option value="TOUS_RISQUES">
                                                        {t(
                                                            'amendments.create.coverageSection.allRisks',
                                                        )}
                                                    </option>
                                                    <option value="FAP_SAUF">
                                                        {t(
                                                            'amendments.create.coverageSection.fapSauf',
                                                        )}
                                                    </option>
                                                    <option value="FAP_ABSOLUE">
                                                        {t(
                                                            'amendments.create.coverageSection.fapAbsolue',
                                                        )}
                                                    </option>
                                                </select>
                                                <div className="current-val">
                                                    {t(
                                                        'amendments.create.coverageSection.current',
                                                        {
                                                            value:
                                        ...
                                        {selectedFields.includes(
                                            ...
                                            <div className="grid gap-2">
                                                <Label className="am-label">
                                                    {t(
                                                        'amendments.create.coverageSection.incoterm',
                                                    )}
                                                </Label>
                                                <Input
                                                    className="h-11"
                                                    ...
                                                    placeholder={t(
                                                        'amendments.create.coverageSection.incotermPlaceholder',
                                                    )}
                                                />
                                                <div className="current-val">
                                                    {t(
                        ...
                        {selectedFields.some((f) => listFields.includes(f)) && (
                            <div className="am-card">
                                <div className="am-card-hdr">
                                    <div className="am-card-ttl">
                                        {t(
                                            'amendments.create.listsSection.title',
                                        )}
                                    </div>
                                </div>
                                <div className="am-card-body">
                                    {selectedFields.includes('clauses') && (
                                        <div className="grid gap-2">
                                            <Label className="am-label">
                                                {t(
                                                    'amendments.create.listsSection.clauses',
                                                )}
                                            </Label>
                                            ...
                                            <div className="tag-input-row">
                                                <input
                                                    ...
                                                    placeholder={t(
                                                        'amendments.create.listsSection.clausesPlaceholder',
                                                    )}
                                                />
                                                <button
                                                    type="button"
                                    ...
                                    {selectedFields.includes('exclusions') && (
                                        <div className="grid gap-2">
                                            <Label className="am-label">
                                                {t(
                                                    'amendments.create.listsSection.exclusions',
                                                )}
                                            </Label>
                                            <div className="tag-list">
                                            ...
                                            <div className="tag-input-row">
                                                <input
                                                    ...
                                                    placeholder={t(
                                                        'amendments.create.listsSection.exclusionsPlaceholder',
                                                    )}
                                                />
                                                <button
                                                    type="button"
                        ...
                        <div style={{ display: 'flex', gap: 8 }}>
                            <Button
                                type="submit"
                                disabled={
                                    processing || selectedFields.length === 0
                                }
                                className="h-10 bg-[#1e3a8a] px-5 text-white hover:bg-[#1e40af]"
                            >
                                {processing ? (
                                    t('amendments.create.saving')
                                ) : (
                                    <>
                                        <FileText size={14} />{' '}
                                        {t('amendments.create.submit')}
                                    </>
                                )}
                            </Button>
                            <Button
