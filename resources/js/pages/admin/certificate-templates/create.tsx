            ...
            onSuccess: (page: any) => {
                ...
                if (pendingLogo) {
                    ...
                    if (newId) {
                        ...
                        router.post(
                            route('admin.certificate-templates.logo', {
                                certificateTemplate: newId,
                            }),
                            fd,
                            { forceFormData: true },
                        );
...
export function TemplateForm({
    ...
    const removePrimeLine = (i: number) =>
        setData(
            'prime_breakdown_lines',
            data.prime_breakdown_lines.filter(
                ...
                <div className="tf-wrap">
                    ...
                    >
                        ...
                        {logoCard ? (
                            ...
                            <div className="tf-card">
                                <div className="tf-card-hdr">
                                    <div className="tf-card-ttl">
                                        {t('form.logo.title')}
                                    </div>
                                    <div className="tf-card-sub">
                                        {t('form.logo.subtitleOptional')}
                                    </div>
                                </div>
                        ...
                        <div className="tf-card">
                            ...
                            <div className="tf-card-body">
                                <div className="form-grid">
                                    <div className="grid gap-2">
                                        ...
                                        {conflictingTemplateName && (
                                            ...
                                            >
                                                {t(
                                                    'form.identification.conflict',
                                                    {
                                                        name: conflictingTemplateName,
                                                    },
                                                )}
                                            </p>
                                        )}
                                ...
                                <div className="form-grid">
                                    <div className="grid gap-2">
                                        <Label className="tf-label">
                                            {t('form.identification.currency')}
                                        </Label>
                                        <select
                                            className="tf-select"
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder={t(
                                                'form.identification.cityPlaceholder',
                                            )}
                                        />
                                    </div>
                                </div>
                                <div className="form-grid">
                                    <div className="grid gap-2">
                                        <Label className="tf-label">
                                            {t(
                                                'form.identification.numberPrefix',
                                            )}
                                        </Label>
                                        <Input
                                            className="h-11"
                                            value={data.number_prefix ?? ''}
                                            onChange={(e) =>
                                                setData(
                                                    'number_prefix',
                                                    e.target.value,
                                            ...
                                            placeholder={t(
                                                'form.identification.numberPrefixPlaceholder',
                                            )}
                                        />
                                    </div>
                                    <div className="grid gap-2">
                                        <Label className="tf-label">
                                            {t(
                                                'form.identification.numberPadding',
                                            )}
                                        </Label>
                                        <Input
                                            className="h-11"
                        ...
                        <div className="tf-card">
                            ...
                            <div className="tf-card-body">
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="grid gap-2">
                                        <Label className="tf-label">
                                            {t('form.company.capital')}
                                        </Label>
                                        <Input
                                            className="h-11"
                                            value={data.company_capital ?? ''}
                                            onChange={(e) =>
                                                setData(
                                                    'company_capital',
                                                    e.target.value,
                                            ...
                                            placeholder={t(
                                                'form.company.capitalPlaceholder',
                                            )}
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="tf-card">
                            ...
                            <div className="tf-card-body">
                                <Toggle
                                    ...
                                    setData={setData}
                                    field="is_bilingual"
                                    label={t('form.options.bilingual')}
                                    hint={t('form.options.bilingualHint')}
                                />
                                <Toggle
                                    data={data}
                                    setData={setData}
                                    field="has_container_options"
                                    label={t('form.options.containerOptions')}
                                    hint={t(
                                        'form.options.containerOptionsHint',
                                    )}
                                />
                                <Toggle
                                    data={data}
                                    setData={setData}
                                    field="has_flight_number"
                                    label={t('form.options.flightNumber')}
                                    hint={t('form.options.flightNumberHint')}
                                />
                                <Toggle
                                    data={data}
                                    setData={setData}
                                    field="has_vessel_name"
                                    label={t('form.options.vesselName')}
                                    hint={t('form.options.vesselNameHint')}
                                />
                                <Toggle
                                    data={data}
                                    setData={setData}
                                    field="has_currency_rate"
                                    label={t('form.options.currencyRate')}
                                    hint={t('form.options.currencyRateHint')}
                                />
                            </div>
                        </div>
                        ...
                        <div className="tf-card">
                            <div className="tf-card-hdr">
                                <div className="tf-card-ttl">
                                    {t('form.primeLines.title')}
                                </div>
                                <div className="tf-card-sub">
                                    {t('form.primeLines.subtitle')}
                                </div>
                            </div>
                            <div className="tf-card-body">
                                <div
                                ...
                                >
                                    ...
                                    >
                                        {t('form.primeLines.columnLabelFr')}
                                    </span>
                                    <span
                                        style={{
                                            fontSize: 10,
                                    ...
                                    >
                                        {t('form.primeLines.columnLabelEn')}
                                    </span>
                                    <span />
                                </div>
                                {data.prime_breakdown_lines.map(
                                    (line: any, i: number) => (
                                        <div key={i} className="prime-row">
                                            <input
                                                ...
                                                placeholder={t(
                                                    'form.primeLines.keyPlaceholder',
                                                )}
                                            />
                                            <input
                                                className="prime-input"
                                                ...
                                                placeholder={t(
                                                    'form.primeLines.labelPlaceholder',
                                                )}
                                            />
                                            <input
                                                className="prime-input"
                                                ...
                                                placeholder={t(
                                                    'form.primeLines.labelEnPlaceholder',
                                                )}
                                            />
                                            <button
                                                type="button"
