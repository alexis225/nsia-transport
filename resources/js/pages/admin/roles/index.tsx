    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                {t('index.createModal.title')}
                            </p>
                            <p style={{ fontSize: 11, color: '#94a3b8' }}>
                                {t('index.createModal.subtitle')}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div
                    style={{ overflowY: 'auto', flex: 1, padding: '18px 22px' }}
                >
                    <form onSubmit={submit}>
                        <div style={{ marginBottom: 16 }}>
                            ...
                            <input
                                ...
                                placeholder={t(
                                    'index.createModal.namePlaceholder',
                                )}
                                style={{
                                    width: '100%',
                                    padding: '10px 13px',
                        ...
                        >
                            {t('index.createModal.permissionsLabel', {
                                                ...
                                                >
                                                    <div
                                                        style={{
                                                            ...
                                                            height: 15,
                                                            borderRadius: 4,
                                                            border: `1.5px solid ${allChecked ? '#3b4fd8' : '#cbd5e1'}`,
                                                            background:
                                                                allChecked
                                                                    ? '#3b4fd8'
                                                                    : someChecked
        ...
        >
            ...
            >
                    ...
                    >
                        <div
                            style={{
                                ...
                                height: 36,
                                background:
                                    ROLE_COLORS[role.name]?.bg ?? '#f1f5f9',
                                borderRadius: 9,
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                        ...
                        >
                            <Shield
                                size={17}
                                color={
                                    ROLE_COLORS[role.name]?.color ?? '#64748b'
                                }
                            />
                        </div>
                        <div>
                            ...
                            >
                                {t('index.editModal.titlePrefix', {
                                    name: role.name.replace(/_/g, ' '),
                                })}
                            </p>
                            <p style={{ fontSize: 11, color: '#94a3b8' }}>
                                {t('index.count', { count: role.users_count })}{' '}
                                ·{' '}
                                {t('index.permissionsCount', {
                ...
                >
                    <div style={{ marginBottom: 16 }}>
                        ...
                        <input
                            ...
                            style={{
                                ...
                                fontFamily: 'inherit',
                                color: '#1e293b',
                                background: isProtected ? '#f8fafc' : '#f8fafc',
                                border: '1.5px solid #e2e8f0',
                                borderRadius: 9,
                                outline: 'none',
                                boxSizing: 'border-box',
                    ...
                    >
                        {t('index.editModal.permissionsLabel', {
                            count: data.permissions.length,
                        })}
                    </label>
                    <div
                ...
                <div className="rp-page">
                    ...
                    <div className="rp-hdr">
                        <div>
                            ...
                            <p className="rp-sub">
                                {t('index.count', { count: roles.total })}
                            </p>
                        </div>
                        <Button
