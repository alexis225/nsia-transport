...
export default function AdminCertificateRequestsIndex({
    certificateRequests,
    filters,
    counts,
}: Props) {
    ...
    const STATUS_TABS: { key: string; label: string }[] = [
        ...
        {
            key: 'INFO_REQUESTED',
            label: t('requests.index.tabs.infoRequested'),
        },
                ...
                >
                    {STATUS_TABS.map((tab) => {
                        const count =
                            tab.key === ''
                                ? undefined
                                : ((counts as any)[tab.key] as number);
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <Link
                                                    href={route(
                                                        'admin.certificate-requests.show',
                                                        {
                                                            certificateRequest:
                                                                cr.id,
                                                        },
