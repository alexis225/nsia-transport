...
export default function TenantEdit({ tenant }: Props) {
    ...
    const { data, setData, put, processing, errors, recentlySuccessful } =
        useForm({
            ...
            subscription_limit_config: tenant.subscription_limit_config ?? {
                nn300_limit: 0,
            },
            settings: {
    ...
    const handleLogoUpload = () => {
        ...
        router.post(
            route('admin.tenants.logo.update', { tenant: tenant.id }),
            formData,
            {
                forceFormData: true,
                onSuccess: () => {
    ...
    const handleLogoRemove = () => {
        if (!confirm(t('edit.logo.confirmRemove'))) {
            return;
        }

        router.delete(
            route('admin.tenants.logo.remove', { tenant: tenant.id }),
            {
                onSuccess: () => {
                    setLogoPreview(null);
                    setLogoFile(null);
                ...
                <div className="te-wrap">
                    ...
                    <div className="te-hero">
                        ...
                        <div className="te-hero-info">
                            <div className="te-hero-title">
                                {t('edit.hero.title', { name: tenant.name })}
                            </div>
                            <div className="te-hero-sub">
                                {t('edit.hero.sub', {
                                    code: tenant.code,
                    ...
                    <div className="te-card">
                        <div className="te-card-hdr">
                            <div className="te-card-ttl">
                                {t('edit.logo.title')}
                            </div>
                            <div className="te-card-sub">
                                {t('edit.logo.subtitle')}
                            </div>
                        </div>
                            ...
                            >
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        >
                                            <option value="fr">
                                                {t('edit.fields.localeFr')}
                                            </option>
                                            <option value="en">
                                                {t('edit.fields.localeEn')}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            >
                                                {data.is_active
                                                    ? t('edit.status.active')
                                                    : t('edit.status.inactive')}
                                            </div>
                                            <div
                                                style={{
                                                    fontSize: 11,
                                            ...
                                            >
                                                {data.is_active
                                                    ? t(
                                                          'edit.status.activeDesc',
                                                      )
                                                    : t(
                                                          'edit.status.inactiveDesc',
                                                      )}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className="grid gap-2">
                                            <Label className="te-label">
                                                {t('edit.print.headOffice')}
                                            </Label>
                                            <textarea
                                                rows={3}
                                                value={
                                                    data.settings.siege_social
                                                }
                                                onChange={(e) =>
                                                    setSetting(
                                                        'siege_social',
                                                ...
                                                placeholder={t(
                                                    'edit.print.headOfficePlaceholder',
                                                )}
                                                style={{
                                                    width: '100%',
                                                    padding: '10px 12px',
                                        ...
                                        <div className="form-grid">
                                            <div className="grid gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder={t(
                                                        'edit.print.rccmPlaceholder',
                                                    )}
                                                />
                                            </div>
                                            <div className="grid gap-2">
                                                <Label className="te-label">
                                                    {t('edit.print.regulator')}
                                                </Label>
                                                <Input
                                                    className="h-11"
                                                    value={
                                                        data.settings.regulator
                                                    }
                                                    onChange={(e) =>
                                                        setSetting(
                                                            'regulator',
                                                    ...
                                                    placeholder={t(
                                                        'edit.print.regulatorPlaceholder',
                                                    )}
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <textarea
                                                ...
                                                placeholder={t(
                                                    'edit.print.paymentAddressPlaceholder',
                                                )}
                                                style={{
                                                    width: '100%',
                                                    padding: '10px 12px',
                                        ...
                                        <div className="form-grid">
                                            <div className="grid gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder={t(
                                                        'edit.print.surveyorNamePlaceholder',
                                                    )}
                                                />
                                            </div>
                                            <div className="grid gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder={t(
                                                        'edit.print.surveyorAddressPlaceholder',
                                                    )}
                                                />
                                            </div>
                                        </div>
