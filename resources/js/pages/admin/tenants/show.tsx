                ...
                <div className="ts-wrap">
                    ...
                    <div className="ts-hero">
                        ...
                        <div className="ts-hero-info">
                            ...
                            <div className="ts-hero-sub">
                                {tenant.code} · {tenant.currency_code} ·{' '}
                                ...
                                <span
                                    ...
                                    style={{
                                        ...
                                        color: tenant.is_active
                                            ? '#86efac'
                                            : '#fca5a5',
                                        border: `1px solid ${tenant.is_active ? 'rgba(34,197,94,0.3)' : 'rgba(239,68,68,0.3)'}`,
                                    }}
                                >
                                    {tenant.is_active
                                        ? `● ${t('show.status.active')}`
                                        : `● ${t('show.status.inactive')}`}
                                </span>
                                <span
                                    className="ts-badge"
                                    style={{
                    ...
                    <div className="ts-card">
                        <div className="ts-card-hdr">
                            <div
                                className="ts-card-ico"
                                style={{ background: '#eff6ff' }}
                            >
                                <Building2 size={15} color="#3b82f6" />
                            </div>
                            <span className="ts-card-ttl">
                                {t('show.config.title')}
                            </span>
                        </div>
                        <div className="ts-card-body">
                            <div className="info-grid">
                                ...
                                <div className="info-item">
                                    <span className="info-label">
                                        <Globe size={10} />
                                        {t('show.config.locale')}
                                    </span>
                                    <span className="info-value">
                                        {tenant.settings?.locale === 'fr'
                                            ? t('show.config.localeFr')
                                            : t('show.config.localeEn')}
                                    </span>
                                </div>
                                <div className="info-item">
                                    <span className="info-label">
                                        <Clock size={10} />
                                        {t('show.config.timezone')}
                                    </span>
                                    <span className="info-value">
                                        {tenant.settings?.timezone ?? '—'}
                                    </span>
                                ...
                                <div className="info-item">
                                    <span className="info-label">
                                        <Shield size={10} />
                                        {t('show.config.nn300Limit')}
                                    </span>
                                    <span className="info-value">
                                        {(
                                            tenant.subscription_limit_config
                                                ?.nn300_limit ?? 0
                                                ...
                                                style={{
                                                    ...
                                                    background:
                                                        certificateTemplate.is_active
                                                            ? '#f0fdf4'
                                                            : '#f8fafc',
                                                    color: certificateTemplate.is_active
                                                        ? '#15803d'
                                                        : '#94a3b8',
                                                }}
                                            >
                                                {certificateTemplate.is_active
                                                    ? t(
                                                          'show.template.activated',
                                                      )
                                                    : t(
                                                          'show.template.deactivated',
                                                      )}
                                            </span>
                                        </div>
                                    </div>
