            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                {t('index.purgeModal.title')}
                            </p>
                            <p style={{ fontSize: 11, color: '#94a3b8' }}>
                                {t('index.purgeModal.subtitle')}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div style={{ padding: '20px 22px' }}>
                    ...
                    >
                        ...
                        <Button
                            onClick={() =>
                                destroy(route('admin.audit-logs.purge'), {
                                    onSuccess: onClose,
                                })
                            }
                            disabled={processing}
                        ...
                        <div className="al-hdr-actions">
                            ...
                            {isSA && (
                                <Button
                                    ...
                                    variant="outline"
                                    className="h-10 gap-1.5 border-red-200 px-4 text-sm text-red-600 hover:bg-red-50"
                                >
