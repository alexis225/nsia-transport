                ...
                <div className="ls-wrap">
                    ...
                    <div className="ls-card">
                        <div className="ls-card-hdr">
                            <div
                                className="ls-card-ico"
                                style={{ background: '#eff6ff' }}
                            >
                                <User size={15} color="#3b82f6" />
                            </div>
                            <span className="ls-card-ttl">
                                {t('show.generalInfo')}
                            </span>
                        </div>
                    ...
                    {(log.old_values || log.new_values) && (
                        <div className="ls-card">
                            <div className="ls-card-hdr">
                                ...
                                <span className="ls-card-ttl">
                                    {t('show.modifications')}
                                </span>
                            </div>
                            <div className="ls-card-body">
                                <div className="diff-grid">
                                    <div
                                        className={`diff-box ${log.old_values ? 'diff-old' : ''}`}
                                    >
                                        ...
                                        {log.old_values ? (
                                            ...
                                            >
                                                {t('show.noPreviousValue')}
                                            </span>
                                        )}
                                    </div>
                                    <div
                                        className={`diff-box ${log.new_values ? 'diff-new' : ''}`}
                                    >
                                        <div className="diff-title">
                                            {t('show.after')}
                                        </div>
