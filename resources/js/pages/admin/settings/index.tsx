...
export default function SettingsIndex({ nn300Ceiling, treatyLimit }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Paramètres généraux — NSIA Transport"/>
            <style>{`
            ...
            <div className="flex h-full flex-1 flex-col overflow-x-auto p-4">
                <div className="set-wrap">
                    <div className="set-hero">
                        ...
                        <div>
                            <div className="set-hero-title">Paramètres généraux</div>
                            <div className="set-hero-sub">Réglages uniques pour toute l'application — pas par filiale, pas par contrat</div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:16 }}>
                        <div className="set-card">
                            <div className="set-card-hdr">
                                <div className="set-card-ttl">Plafonds NN300 / Traité</div>
                                <div className="set-card-sub">
                                    Un contrat dont le « Plein d'Assurance » dépasse le plafond NN300 est automatiquement
                                    soumis en brouillon pour validation par le Groupe (DTAG). Une fois validé, ses
                                    certificats sont couverts jusqu'au Plafond Traité sans nouvelle escalade.
                                </div>
                            </div>
                            <div className="set-card-body">
                                <div className="grid gap-2">
                                    <Label className="set-label">Plafond NN300 (FCFA) *</Label>
                                ...
                                <div className="grid gap-2">
                                    <Label className="set-label">Plafond ou limite Traité (FCFA) *</Label>
                        ...
                        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                            ...
                            {recentlySuccessful && <span className="status-ok"><Check size={13}/> Enregistré</span>}
                        </div>
                    </form>
                </div>
            </div>
