...
export const DEFAULT_FIELD_POSITIONS: FieldPosition[] = [
    ...
    { key: 'rate_divers',           top: 145, left: 150, width: 20, align: 'right' },
    { key: 'amount_divers',         top: 145, left: 172, width: 25, align: 'right' },
    { key: 'rate_surprime',         top: 150, left: 150, width: 20, align: 'right' },
    { key: 'amount_surprime',       top: 150, left: 172, width: 25, align: 'right' },
    // Prime Nette = RO + RG + Divers + Surprime — positionnée juste
    // au-dessus d'Accessoires (sous-total, pas de taux propre).
    { key: 'amount_prime_nette',    top: 155, left: 172, width: 25, align: 'right', bold: true },
    { key: 'rate_accessoires',      top: 160, left: 150, width: 20, align: 'right' },
    { key: 'amount_accessoires',    top: 160, left: 172, width: 25, align: 'right' },
    { key: 'rate_taxe',             top: 165, left: 150, width: 20, align: 'right' },
    { key: 'amount_taxe',           top: 165, left: 172, width: 25, align: 'right' },
