            ...
            <div className="flex h-full flex-1 flex-col overflow-x-auto p-4">
                <div className="uc-wrap">
                    ...
                    <div className="uc-hero">
                        <div className="uc-hero-ico">
                            <UserPlus size={22} color="rgba(255,255,255,0.8)" />
                        </div>
                    ...
                    <div className="uc-card">
                        <div className="uc-card-hdr">
                            <div className="uc-card-ttl">
                                {t('create.form.title')}
                            </div>
                            <div className="uc-card-sub">
                                {t('create.form.subtitle')}
                            </div>
                        </div>
                            ...
                            >
                                ...
                                <div className="form-grid">
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder={t(
                                                'create.fields.firstNamePlaceholder',
                                            )}
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder={t(
                                                'create.fields.lastNamePlaceholder',
                                            )}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t(
                                            'create.fields.emailPlaceholder',
                                        )}
                                        autoComplete="email"
                                    />
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="grid gap-2">
                                        <Label className="uc-label">
                                            {t('create.fields.passwordConfirm')}
                                        </Label>
                                        <div className="pw-wrap">
                                            <Input
                                                className="uc-input"
