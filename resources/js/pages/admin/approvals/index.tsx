...
interface Workflow {
    ...
    contract: {
        ...
        declared_max_value: number | null;
                ...
                <div className="al-page">
                    ...
                    <div className="kpi-grid">
                        ...
                        <div
                            ...
                            style={{
                                borderColor:
                                    overdue > 0 ? '#fecaca' : undefined,
                            }}
                        >
                            <div
                                className="kpi-val"
                                style={{
                                    color: overdue > 0 ? '#dc2626' : '#1e293b',
                                }}
                            >
                                {overdue}
                            </div>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {t('index.table.declaredValue')}
                                        </th>
                                        <th>
                                            {t('index.table.thresholdExceeded')}
                                        </th>
                                        <th>
                                            {t('index.table.treatyThreshold')}
                                        </th>
                                        {isSA && (
                                            ...
                                            <tr key={w.id}>
                                                ...
                                                <td>
                                                    {w.is_overdue ? (
                                                        ...
                                                        <span
                                                            className={`${w.hours_left < 8 ? 'timer-urgent' : 'timer-ok'}`}
                                                            style={{
                                                                fontSize: 11,
                                                            }}
                                                        >
                                                            <Clock size={10} />{' '}
                                                            {w.hours_left.toFixed(
                                                                1,
                                                            )}
                                                            h
                                                        </span>
