...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Les clés suivent celles de lang/en/validation.php : toute règle ajoutée
    | par une future version de Laravel doit être reportée dans les trois
    | langues (fr, en, pt) déclarées par config('app.supported_locales').
    |
    */
