...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As chaves seguem as de lang/en/validation.php: qualquer regra adicionada
    | por uma futura versão do Laravel deve ser replicada nos três idiomas
    | (fr, en, pt) declarados em config('app.supported_locales').
    |
    */
    ...
    'doesnt_start_with' => 'O campo :attribute não pode começar por um dos seguintes valores: :values.',
    ...
    'gte' => [
        'array' => 'O campo :attribute deve conter pelo menos :value elementos.',
    ...
    'lte' => [
        'array' => 'O campo :attribute não pode conter mais de :value elementos.',
    ...
    'max' => [
        'array' => 'O campo :attribute não pode conter mais de :max elementos.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute indicado apareceu numa fuga de dados. Escolha outro.',
    ],
