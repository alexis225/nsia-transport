...
class CommissionController extends Controller
{
    public function rules(Request $request): Response
    {
        ...
        return Inertia::render('admin/commissions/rules', [
            ...
            'brokers' => $brokers,
            'contracts' => $contracts,
            'baseTypes' => CommissionRule::BASE_TYPE_LABELS,
    ...
    public function bordereau(Request $request): Response
    {
        ...
        $query = CommissionTransaction::with([
            ...
            ->whereHas('certificate', fn ($q) => $q->whereBetween('issued_at', [$periodFrom.' 00:00:00', $periodTo.' 23:59:59'])
            )
    ...
    private function exportCsv($transactions, string $filename): StreamedResponse
    {
