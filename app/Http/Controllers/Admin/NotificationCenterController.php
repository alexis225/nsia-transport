...
class NotificationCenterController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $stats = [
            'total' => Notification::forUser($user->id)->inApp()->where('created_at', '>=', $since)->count(),
            'unread' => Notification::forUser($user->id)->inApp()->unread()->count(),
            'today' => Notification::forUser($user->id)->inApp()->whereDate('created_at', today())->count(),
        ];
