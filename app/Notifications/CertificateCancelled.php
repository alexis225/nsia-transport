...
class CertificateCancelled extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->view('notifications.email', [
                ...
                'introLines'  => [
                    "Le certificat suivant a été annulé.",
                ...
                'subject'     => "Certificat {$this->certificate->certificate_number} annulé",
            ]);
    }
}